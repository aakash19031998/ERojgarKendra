package com.twocoms.rojgarkendra.goodiesscreen.controler;
...
public class MyGoodiesStoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_goodies_store);
        initialization();
    ...
    void initialization(){
        ...
        titleToolbar.setText(AppConstant.NAME_MY_GOODIES_STORES);
    }
